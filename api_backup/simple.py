...
EDU_BANNER = (
    "Educational purposes only — verify with healthcare providers. No PHI stored."
)
...
DISEASE_DB = {
    "hypertension": {
        ...
        "references": [
            {
                "title": "AHA Blood Pressure Guidelines",
    ...
    "diabetes": {
        ...
        "references": [
            {
                "title": "ADA Diabetes Standards",
                "url": "https://diabetescare.diabetesjournals.org/",
    ...
    "pneumonia": {
        ...
        "references": [
            {
                "title": "CDC Pneumonia Information",
        ...
        if path == "/api/v1/health":
            ...
            response = {
                ...
                "results": (
                    [
                        {
                            "title": "Sample PubMed Article About "
                            + (q if q else "Medical Research"),
