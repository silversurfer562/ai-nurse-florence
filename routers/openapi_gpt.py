...
async def get_openapi_yaml():
    ...
    try:
        ...
        response = requests.get(
            "https://ai-nurse-florence-production.up.railway.app/openapi.json"
        )
        ...
        openapi_json = {
            ...
            "servers": [{"url": "https://ai-nurse-florence-production.up.railway.app"}],
        }
    ...
    openapi_json["info"]["x-openai-manifest"] = {
        ...
        "auth": {"type": "none"},  # Change to "oauth" or "api_key" when ready
