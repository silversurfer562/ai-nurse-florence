...
This file intentionally keeps enhancements deterministic and test-friendly.
"""
from typing import Tuple, Optional
from utils.logging import get_logger
...
COMMON_CONDITIONS = [
    ...
    Deterministic, test-friendly prompt enhancements and clarification
    suggestions for services: summarize, education, and disease lookup.
    """
    from typing import Tuple, Optional
    from utils.logging import get_logger
    ...
    def enhance_summarize_prompt(prompt: str) -> Tuple[str, bool]:
        ...
        if prompt.startswith("summarize"):
            ...
            if topic:
                # Include 'clinical summary' phrasing to match tests
                return (
        ...
        for cond in COMMON_CONDITIONS:
            if cond in prompt and "summar" not in prompt:
                return (f"Summarize key clinical information about {cond} for healthcare professionals", True)
