...
CACHE_HIT_COUNT = Counter("api_cache_hit_count", "Number of cache hits", ["cache_key"])

CACHE_MISS_COUNT = Counter(
    "api_cache_miss_count", "Number of cache misses", ["cache_key"]
)
...
def record_external_request(service: str, operation: str) -> None:
    ...
    """
    EXTERNAL_SERVICE_REQUEST_COUNT.labels(service=service, operation=operation).inc()
